...
{
	addWeapon("Æø¹ß_°Ë", ITEM_SKILL, WEAPON_EXPLOSION, false, "Æø¹ß_°Ë", 1000, 500);
	addWeapon("½ºÆÄÀÌÅ©_°Ë", ITEM_SKILL, WEAPON_SPIKES, false, "½ºÆÄÀÌÅ©_°Ë", 1000, 500);
	addWeapon("ºÒ_°Ë", ITEM_SKILL, WEAPON_FIRE, false, "ºÒ_°Ë", 1000, 500);
	addWeapon("ºí·¢È¦_°Ë", ITEM_SKILL, WEAPON_BLACKHOLE, false, "ºí·¢È¦_°Ë", 1000, 500);
	addWeapon("ÆÄÀÌ¾îº¼_°Ë", ITEM_SKILL, WEAPON_FIREBALL, false, "ÆÄÀÌ¾îº¼_°Ë", 1000, 500);
}

...
HRESULT itemManager::init()
{
	...
	IMAGEMANAGER->addFrameImage("¸ó½ºÅÍ¼ÒÀç", "Images/monster/¸ó½ºÅÍ¼ÒÀç.bmp", 160, 40, 4, 1);
	IMAGEMANAGER->addFrameImage("¸ó½ºÅÍ¼ÒÀçsmall", "Images/monster/¸ó½ºÅÍ¼ÒÀçsmall.bmp", 64, 16, 4, 1);
...
{
	addWeapon("Æø¹ß_°Ë", ITEM_SKILL, WEAPON_EXPLOSION, false, "Æø¹ß_°Ë", 500, 250);
	addWeapon("½ºÆÄÀÌÅ©_°Ë", ITEM_SKILL, WEAPON_SPIKES, false, "½ºÆÄÀÌÅ©_°Ë", 1000, 500);
	addWeapon("ºÒ_°Ë", ITEM_SKILL, WEAPON_FIRE, false, "ºÒ_°Ë", 1500, 750);
	addWeapon("ºí·¢È¦_°Ë", ITEM_SKILL, WEAPON_BLACKHOLE, false, "ºí·¢È¦_°Ë", 2000, 1000);
	addWeapon("ÆÄÀÌ¾îº¼_°Ë", ITEM_SKILL, WEAPON_FIREBALL, false, "ÆÄÀÌ¾îº¼_°Ë", 3000, 1500);
}
